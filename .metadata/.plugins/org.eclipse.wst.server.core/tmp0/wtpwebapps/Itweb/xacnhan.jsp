  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="sachAdminController">Quản lý sách</a></li>
       <li><a href="xacnhanAdminController">Xác nhận chuyển tiền</a></li>
...
<table width="1000" align="center" class="table">
   <%
     ArrayList<xacnhanbean> ds= (ArrayList<xacnhanbean>)request.getAttribute("dsxacnhan");
   ...
   %>
     <tr>
        ...
        <td><a href="xacnhanchitietController?mct=<%=xn.getMaChiTietHoaDon()%>">
